...
//   TextEditingController cure_disases = TextEditingController();
...
//       missingfield.add("please enter the product name");
//     }if(product_number.text.isEmpty || product_number.text.length!=6){
//       missingfield.add("please enter the phone_number");
//     }if(quantity.text.isEmpty){
//       missingfield.add("please enter the product quantity");
//     }if(price.text.isEmpty){
//       missingfield.add("please enter the product price");
//     }if(cure_disases.text.isEmpty){
//       missingfield.add("please enter the cure diseases name");
//     }if(about_product.text.isEmpty){
//       missingfield.add("please enter the about product");
//     }if(product_type.text.isEmpty){
//       missingfield.add("please enter the product type");
//     }if(medicine_image==null){
//       missingfield.add("please upload the product image");
//     }
...
//         content: Text("makes sure the Product details is correct!",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black,fontSize: 20),),
//         actions: [
//           Row(
...
//     request.fields['cure_disases'] = cure_disases.text;
...
//       Navigator.push(
//           context, MaterialPageRoute(builder: (context) => order_success()));
//     } else {
//       print("upload faild: ${response.statusCode}");
//     }
//   }
//
//   @override
...
//               350,
//               6,
//               "enter the Medicine number unique",
