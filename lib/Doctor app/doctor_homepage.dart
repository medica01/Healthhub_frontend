              ...
              children: [
                Padding(
                  ...
                  child: CircleAvatar(
                    ...
                    ?NetworkImage(
                        "http://$ip:8000${get_doc_details!.doctorImage}"): NetworkImage(""),
                  ),
                ),
                Padding(
                          ...
                          GestureDetector(
                              onTap: () {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => doc_location()));
                              },
                              child: one("Location", Icons.location_on_sharp)),
                          GestureDetector(
                              onTap: () {
                                Navigator.push(
                                    context,
                              ...
                              child:
                                  one("Medicine", FontAwesomeIcons.kitMedical)),
